...
Find solutions to common issues and problems when using the Load Testing & Optimization Agent.
...
<Accordion>
  ...
  <AccordionItem title="Browser Test Timeouts">
    **Symptoms**: `Browser test timed out` or `xk6-browser container timeout`
...
<Accordion>
  ...
  <AccordionItem title="Data Corruption">
    ...
    **Solutions**:
    ...
    python run_test.py configs/your-config.yaml
    ```
...
<Accordion>
  <AccordionItem title="Browser Container Failures">
    ...
    **Solutions**:
    ...
    # Check browser image
    docker images | grep xk6-browser
    
    # Rebuild browser image
    docker build -f docker/Dockerfile.browser -t xk6-browser-test .
    ```
  ...
  <AccordionItem title="Core Web Vitals Not Captured">
    ...
    **Solutions**:
    ...
    cat tests/browser_load_test.js
...
<Accordion>
  ...
  <AccordionItem title="Application Logs">
    ...
    python run_test.py configs/your-config.yaml 2>&1 | tee test.log
...
<Accordion>
  <AccordionItem title="Docker Recovery">
    ...
    # Verify images
    docker images | grep -E "(k6-load-test|xk6-browser-test)"
    ```
  </AccordionItem>
